...
export default function CardProduto(Props: PropsType) {
    return (
        <div className="h-60 w-96 bg-vavaAzul-100 rounded-xl flex flex-col items-center justify-between relative">
            <div className="flex justify-center items-center h-5/6">
                <img className="w-3/4" src={Props.imagem} alt="" />
                <HeartStraight size={25} weight="bold" color="white" className="absolute right-3 top-2"/>
            </div>
